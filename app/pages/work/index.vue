...
<template>
  <div class="bg-paper min-h-screen">
    <!-- MOBILE: header fijo arriba, cards en su propia caja con scroll contenido -->
    <div class="md:hidden fixed inset-x-0 top-[76px] bottom-[96px] flex flex-col z-10">
      <div class="bg-paper px-6 pt-6 pb-4 shrink-0">
        ...
        <p class="mt-4 text-ink-soft text-base">
          Me dedico a diseñar productos, marcas y experiencias donde el detalle y la funcionalidad realmente importan.
        </p>
    ...
    <!-- DESKTOP: layout normal, scroll horizontal de tarjetas -->
